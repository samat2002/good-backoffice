...
import type { PortfolioList, Portfolio } from "~/misc/user";
import defaultUserImage from "@/assets/images/default-user.png"
import errorImage from "@/assets/images/error.png"

definePageMeta({ middleware: ["auth"] });
const { generatePortfolioListID, insertPortfolioList, } = usePortfolioList();
...
onMounted(async () => {
  try {
    const id = await generatePortfolioListID()
    portfolio_list.value.portfolio_list_id = id
  } catch (e) {
    console.log(e)
  }
})
...
function validateForm(): boolean {
  ...
  if (!(portfolio_list_id && portfolio_list_name && portfolio_list_detail)) {
          ...
          <v-row>
            <v-col>
              ...
              <v-col cols="12" sm="6" lg="12">
                ...
                <v-textarea v-model="portfolio_list.portfolio_list_detail" density="compact" variant="outlined"
            ...
            <v-col cols="12" sm="6" lg="4">
              ...
              <v-text-field v-model="portfolio_list.portfolio_list_name" :rules="[rules.required]" density="compact"
