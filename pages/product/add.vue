...
import type { Product } from "~/misc/user.d";
import defaultUserImage from "@/assets/images/default-user.png"
import errorImage from "@/assets/images/error.png"

definePageMeta({ middleware: ["auth"] });
const { generateProductID, insertProduct, } = useProduct();
...
<template>
  <v-breadcrumbs :items="[
    { title: 'สินค้าเเละบริการ', to: '/product', },
        ...
        <v-col cols="12" md="12">
          <v-row>
            ...
            <v-col cols="12" sm="6" lg="4">
              <v-label class="mb-2">ชื่อสินค้าเเละบริการ<span class="text-error ml-1">*</span></v-label>
              <v-text-field v-model="product.product_name" :rules="[rules.required]" density="compact" variant="outlined"
              ...
              <div class="text-center" style="max-width: 400px;">
                <v-avatar size="200px">
                  ...
                  <template v-else-if="product.product_img">
                    <v-img :src="`${publicCtx.apiBaseUrl}${product.product_img}`" aspect-ratio="1" cover
                      max-height="200px">
