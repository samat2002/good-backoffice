...
const { getBannerByID, updateBannerBy } = useBanner();
const { getBannerListBy, updateBannerListBy } = useBannerList();
...
function validateForm(): boolean {
  if (!(banner.value.banner_id && banner.value.banner_name)) {
      ...
      <v-col>
        <v-row>
          ...
          <v-col cols="12" sm="6" lg="6">
            ...
            <v-textarea v-model="banner.banner_name" density="compact" variant="outlined" class="btn-small"></v-textarea>
            <v-col cols="12" md="12">
