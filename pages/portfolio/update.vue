...
const { getPortfolioByID, updatePortfolioBy } = usePortfolio();
...
async function onSubmit() {
  ...
  try {
    ...
    await updatePortfolioBy(portfolio.value);
    ...
    <v-card-text class="py-4">
      <v-row>
        <v-col cols="12" sm="6" lg="4">
          ...
          <v-text-field v-model="portfolio.portfolio_name" :rules="[rules.required]" density="compact" variant="outlined"
